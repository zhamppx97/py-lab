...
# Download the data from: https://drive.google.com/open?id=0B28c493CP9GtMzN1emFoMkJNNlU


# change path to where you saved your data set.

hubway_data = pd.read_csv('D:\zhamppx\hubway_data\hubway_trips.csv', low_memory=False)
hubway_data.head()
...
plt.tight_layout()
plt.show()
# Same path you have used
station_data = pd.read_csv('D:\zhamppx\hubway_data\hubway_stations.csv', low_memory=False)[['id', 'lat', 'lng']]
station_data.head()
